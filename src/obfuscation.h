...
{
public:
    /// Is the inputs associated with this public key? (and there is 20000 Healcap - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of hcap.
