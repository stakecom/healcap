...
public:
	...
	//printf("genesis.hashMerkleRoot = %s\n",genesis.hashMerkleRoot.GetHex().c_str());
        ...
        // Healcap addresses start with 'i'
	...
	vSeeds.push_back(CDNSSeedData("s1", "s1.stakework.com"));
        ...
        strObfuscationPoolDummyAddress = "SealcapcoinDarksendPoo1DummyAdy4viSr";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "testnet.seeder.baseserv.com")); // Healcap's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "testnet.seeder.uksafedns.net")); // Healcap's official testseed 2
        // Testnet Healcap addresses start with 'g'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 0x496f6e;                // hex 57 47 52 in text = HCAP
