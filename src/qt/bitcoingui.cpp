                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Healcap Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Healcap address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hcap: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xHCAP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Healcap Core"), this);
    aboutAction->setStatusTip(tr("Show information about Healcap Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HCAP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Healcap addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Healcap addresses"));
    ...
    openAction->setStatusTip(tr("Open a HCAP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Healcap Core help message to get a list with possible Healcap command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Healcap Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Healcap network", "", count));
}
...
{
    QString strTitle = tr("Healcap Core"); // default title
