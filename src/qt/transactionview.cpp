 ...
 */
    ...
    typeWidget->addItem(tr("Received Healcap from xHCAP"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xHCAP"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xHCAP));
