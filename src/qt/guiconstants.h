...
/* hcap GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HCAP"
#define QAPP_ORG_DOMAIN "healcap-coin.com"
#define QAPP_APP_NAME_DEFAULT "Healcap-Qt"
#define QAPP_APP_NAME_TESTNET "Healcap-Qt-testnet"
