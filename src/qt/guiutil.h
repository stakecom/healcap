...
/** Utility functions used by the Healcap Qt UI.
 */
namespace GUIUtil
{
...
// Render Healcap addresses in monospace font
...
// Parse "hcap:" URI into recipient object, return true on successful parsing
