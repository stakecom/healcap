...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Healcap Core hcap-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hcap-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hcap transaction") + "\n" +
                               "  hcap-tx [options] -create [commands]   " + _("Create hex-encoded hcap transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hcap transaction
