...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Healcap features */
        {"hcap", "masternode", &masternode, true, true, false},
        {"hcap", "listmasternodes", &listmasternodes, true, true, false},
        {"hcap", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hcap", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hcap", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hcap", "masternodedebug", &masternodedebug, true, true, false},
        {"hcap", "startmasternode", &startmasternode, true, true, false},
        {"hcap", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hcap", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hcap", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hcap", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hcap", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hcap", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hcap", "mnbudget", &mnbudget, true, true, false},
        {"hcap", "preparebudget", &preparebudget, true, true, false},
        {"hcap", "submitbudget", &submitbudget, true, true, false},
        {"hcap", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hcap", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hcap", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hcap", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hcap", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hcap", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hcap", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hcap", "checkbudgets", &checkbudgets, true, true, false},
        {"hcap", "mnsync", &mnsync, true, true, false},
        {"hcap", "spork", &spork, true, true, false},
        {"hcap", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"hcap", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> hcap-cli " + methodname + " " + args + "\n";
}
