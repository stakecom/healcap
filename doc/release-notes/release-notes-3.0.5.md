Healcap Core version 3.0.5 is now available from:
...
Healcap Core version 3.0.5 is a recommended update for all users. This release
...
installer (on Windows) or just copy over `/Applications/Healcap-Qt` (on Mac)
or `hcapd`/`hcap-qt` (on Linux).

Compatibility
=============

Healcap Core is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows Vista and later. Windows XP is not supported.

Healcap Core should also work on most other Unix-like systems but is not
...
- `0789160` Fix: check doc script failed due to misspelled backupxHCAP instead of backupxhcap (cevap)
...
- `44e16ef` Replace all occurencies of HCAP-Qt with Healcap-Qt (cevap)
- `e36f97a` Add splashscreens, fixed #10 (cevap)
- `1a08917` Rename all occurencies from ' HCAP ' to ' Healcap ' (cevap)
...
- `6439a59` Rename bitcoin.org to healcapcore.xyz, ref: #13 (cevap)
...
- `e17311c` Healcapian Documentation (#23) (ckti)
- `9d05d8e` Healcap Build Documaentation for Raspian (#24) (ckti)
