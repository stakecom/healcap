...
In order to support loading of multiple wallets in hcap-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hcap.cpp.
...
Changes to hcap.cpp
----------------------
hcap.cpp is the entry point into hcap-qt, and as such, will require some minor modifications to provide hooks for
