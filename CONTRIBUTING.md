Contributing to Healcap Core
============================

The Healcap Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Healcap Core project, and is not to be
confused with overall Healcap Network Protocol consensus changes.

Whether a pull request is merged into Healcap Core rests with the project merge
...
Patches that change Healcap consensus rules are considerably more involved than
...
Where a patch set proposes to change the Healcap consensus, it must have been
...
The project leader is the release manager for each Healcap Core release.
