...
#   c) node1 mines 32 blocks, so now node 0 has 60001hcap, node 1 has 4250hcap, node2 has none.
#   d) node0 sends 601 hcap to node2, in two transactions (301 hcap, then 300 hcap).
