...
RESOURCES += src/qt/hcap.qrc src/qt/hcap_locale.qrc

TRANSLATIONS += src/qt/locale/hcap_bg.ts \
                src/qt/locale/hcap_de.ts \
                src/qt/locale/hcap_en.ts \
                src/qt/locale/hcap_es.ts \
                src/qt/locale/hcap_fi.ts \
                src/qt/locale/hcap_fr.ts \
                src/qt/locale/hcap_it.ts \
                src/qt/locale/hcap_ja.ts \
                src/qt/locale/hcap_pl.ts \
                src/qt/locale/hcap_pt.ts \
                src/qt/locale/hcap_ru.ts \
                src/qt/locale/hcap_sk.ts \
                src/qt/locale/hcap_sv.ts \
                src/qt/locale/hcap_vi.ts \
                src/qt/locale/hcap_zh_CN.ts \
                src/qt/locale/hcap_zh_TW.ts
