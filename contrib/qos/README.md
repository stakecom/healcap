...
This means one can have an always-on hcapd instance running, and another local hcapd/hcap-qt instance which connects to this node and receives blocks from it.
