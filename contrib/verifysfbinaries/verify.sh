...
###   This script attempts to download the signature file SHA256SUMS.asc from healcapcore.xyz
...
SIGNATUREFILE="https://healcapcore.xyz/bin/3.0.4.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://healcapcore.xyz/bin/"
